      ...
      <a-row>
        ...
        <a-col :md="6" :sm="24" :xs="24">
          <div class="footer-center">
            ...
            <div v-if="isCN">
              <a
                href="https://zhuanlan.zhihu.com/ant-design-vue"
                target="_blank"
              >
                <span>知乎专栏</span>
              </a>
            ...
            <div>
              <a
                href="https://github.com/vueComponent/ant-design-vue/releases"
                target="_blank"
              >
            ...
            <div>
              <a
                rel="noopener noreferrer"
                target="_blank"
                :href="`https://vuecomponent.github.io/issue-helper/${
                  isCN ? '?lang=zh' : ''
                }`"
              >
        ...
        <a-col :md="6" :sm="24" :xs="24">
          <div class="footer-center">
            ...
            <div>
              ...
              <span> - </span>
              <span>{{
                isCN ? "企业级 Node 开发框架" : "Enterprise Node Framework"
              }}</span>
            </div>
          </div>
        </a-col>
