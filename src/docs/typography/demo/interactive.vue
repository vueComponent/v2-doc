...
<template>
  ...
  <a-typography-paragraph v-model:content="lengthLimitedStr" :editable="{maxlength: 50, autoSize: { maxRows: 5, minRows: 3 }}" />

  <a-typography-paragraph copyable>This is a copyable text.</a-typography-paragraph>
  <a-typography-paragraph :copyable="{ text: 'Hello, Ant Design!' }">Replace copy text.</a-typography-paragraph>
  ...
  <a-typography-paragraph :copyable="{ tooltips: false }">Hide Copy tooltips.</a-typography-paragraph>
</template>
<script lang="ts">
...
export default defineComponent({
  ...
  components: {
    HighlightOutlined, SmileOutlined, SmileFilled
  }
});
</script>
